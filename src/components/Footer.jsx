        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="text-left"> {/* 이 div에 text-left 추가 */}
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="orbitron text-lg font-bold gradient-text text-left">TCP</h3>
            </div>
          ...
          <div className="text-left"> {/* 이 div에 text-left 추가 */}
            {/* h4 태그에 text-left 추가 */}
            <h4 className="orbitron text-lg font-bold mb-4 text-white text-left">연락처</h4>
            <div className="space-y-2 text-sm text-gray-400">
          ...
          <div className="text-left"> {/* 이 div에 text-left 추가 */}
            {/* h4 태그에 text-left 추가 */}
            <h4 className="orbitron text-lg font-bold mb-4 text-white text-left">법적 정보</h4>
