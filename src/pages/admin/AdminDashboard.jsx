...
import { faHome, faMicrochip, faMemory, faThermometerHalf, faHdd, faNetworkWired, faClock, faCalendarAlt, faUsers, faBars, faBell, faUserSlash, faDatabase, faUserPlus, faServer, faFileAlt, faBullhorn, faNewspaper, faBook, faProjectDiagram, faSave, faChevronDown, faArrowUp, faArrowDown } from '@fortawesome/free-solid-svg-icons';
            ...
            <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="widget-card p-6 rounded-xl">
                        ...
                        <div className="text-4xl font-black gradient-text mb-4">{stats.studies}</div>
                        <ul className="text-sm text-gray-300 space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div className="widget-card p-4 rounded-xl">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-lg font-bold text-white">{stats.server.cpu}%</span>
                        </div>
                        <div className="progress-bar h-2">
                            <div className={`progress-bar-inner ${getProgressBarColor(stats.server.cpu)}`} style={{ width: `${stats.server.cpu}%` }}></div>
                        </div>
                    </div>
                    <div className="widget-card p-4 rounded-xl">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-lg font-bold text-white">{stats.server.ram} / {stats.server.ramTotal} GB</span>
                        </div>
                        <div className="progress-bar h-2">
                            <div className={`progress-bar-inner ${getProgressBarColor((stats.server.ram / stats.server.ramTotal) * 100)}`} style={{ width: `${(stats.server.ram / stats.server.ramTotal) * 100}%` }}></div>
                        </div>
                    </div>
                    <div className="widget-card p-4 rounded-xl flex items-center justify-between">
                        ...
                        <span className="text-lg font-bold text-white">{stats.server.temp}°C</span>
                    </div>
                    <div className="widget-card p-4 rounded-xl">
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center space-x-2">
                            ...
                            <span className="text-lg font-bold text-white">{stats.server.disk}%</span>
                        </div>
                        <div className="progress-bar h-2">
                            <div className={`progress-bar-inner ${getProgressBarColor(stats.server.disk)}`} style={{ width: `${stats.server.disk}%` }}></div>
                        </div>
                    </div>
                    <div className="widget-card p-4 rounded-xl flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            <FontAwesomeIcon icon={faNetworkWired} className="text-yellow-400" />
                            <h5 className="font-semibold text-gray-300">Network</h5>
                        </div>
                        <div className="text-right">
                            <div className="text-sm font-bold text-white"><FontAwesomeIcon icon={faArrowUp} /> TX: {stats.server.networkTx} Mbps</div>
                            <div className="text-sm font-bold text-white"><FontAwesomeIcon icon={faArrowDown} /> RX: {stats.server.networkRx} Mbps</div>
                        </div>
                    </div>
                    <div className="widget-card p-4 rounded-xl flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-bold text-white">{stats.server.uptime}</span>
                    </div>
                    <div className="widget-card p-4 rounded-xl flex items-center justify-between">
                        <div className="flex items-center space-x-2">
