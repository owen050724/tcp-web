    ...
    <>
      ...
      {isModalOpen && selectedStudy && (
        <div
          ...
          onClick={(e) =>
            e.target.id === 'studyDetailModal' && closeStudyModal()
          }
        >
          <div className="modal-content">
            ...
            <h3
              ...
              className="orbitron text-2xl font-bold gradient-text mb-4 text-left"
            >
              {selectedStudy.title}
            </h3>{' '}
            {/* 모달 제목 왼쪽 정렬 */}
            <div className="space-y-3 text-gray-300">
              <p className="text-left">
                <strong className="text-white">기간:</strong>{' '}
                <span id="modal-study-duration">{selectedStudy.period}</span>
              </p>{' '}
              {/* 모달 내용 왼쪽 정렬 */}
              <p className="text-left">
                <strong className="text-white">진행 방식:</strong>{' '}
                <span id="modal-study-method">{selectedStudy.method}</span>
              </p>{' '}
              {/* 모달 내용 왼쪽 정렬 */}
              <p className="text-left">
                <strong className="text-white">장소:</strong>{' '}
                <span id="modal-study-location">{selectedStudy.location}</span>
              </p>{' '}
              {/* 모달 내용 왼쪽 정렬 */}
              <p className="text-left">
                <strong className="text-white">참여 인원:</strong>{' '}
                <span id="modal-study-members">{selectedStudy.members}</span>
              </p>{' '}
              {/* 모달 내용 왼쪽 정렬 */}
              <p className="text-left">
                <strong className="text-white">기술 스택:</strong>{' '}
                <span id="modal-study-techstack">
                  {selectedStudy.techstack}
                </span>
              </p>{' '}
              {/* 모달 내용 왼쪽 정렬 */}
            ...
            <div
              id="modal-study-tags"
              className="flex flex-wrap mt-4 text-left"
            >
              {' '}
              {/* 모달 태그 왼쪽 정렬 */}
              {selectedStudy.tags.map((tag, tagIndex) => (
                <span key={tagIndex} className={`tag ${getTagClassName(tag)}`}>
                  {tag}
                </span>
              ))}
            </div>
