  ...
  return (
    <> {/* React Fragment를 사용하여 여러 요소를 묶습니다. */}
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="feature-card p-6 rounded-xl card-hover">
                ...
                <h3 className="orbitron text-lg font-bold mb-2 text-blue-300">개발자를 위한 동아리</h3>
                <p className="text-sm text-gray-400">전문적인 개발 역량을 키우고 실무 경험을 쌓을 수 있는 최적의 환경</p>
              </div>
              ...
              <div className="feature-card p-6 rounded-xl card-hover">
                ...
                <h3 className="orbitron text-lg font-bold mb-2 text-purple-300">다양한 학습 기회</h3>
                <p className="text-sm text-gray-400">스터디, 프로젝트, 멘토링을 통한 체계적이고 포괄적인 학습 시스템</p>
              </div>
              ...
              <div className="feature-card p-6 rounded-xl card-hover">
                ...
                <h3 className="orbitron text-lg font-bold mb-2 text-green-300">일관된 성과와 결과</h3>
                <p className="text-sm text-gray-400">대회 수상, 프로젝트 성공, 취업 성과 등 검증된 실적과 경험</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="orbitron text-3xl md:text-4xl font-bold gradient-text mb-4">주요 활동</h2>
            <p className="text-xl text-gray-300">TCP에서 경험할 수 있는 다양한 활동들을 소개합니다</p>
          </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden card-hover">
                <div className="promo-placeholder">
                  <div className="text-center">
                    ...
                    <h3 className="orbitron text-lg font-bold text-yellow-300">대회 참가</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-yellow-900 text-yellow-300 rounded-full text-xs">ICPC</span>
                    <span className="px-3 py-1 bg-yellow-900 text-yellow-300 rounded-full text-xs">해커톤</span>
                    <span className="px-3 py-1 bg-yellow-900 text-yellow-300 rounded-full text-xs">창업경진대회</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden card-hover">
                <div className="promo-placeholder">
                  <div className="text-center">
                    ...
                    <h3 className="orbitron text-lg font-bold text-blue-300">스터디 세션</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 rounded-full text-xs">알고리즘</span>
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 rounded-full text-xs">웹개발</span>
                    <span className="px-3 py-1 bg-blue-900 text-blue-300 rounded-full text-xs">AI/ML</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl overflow-hidden card-hover">
                <div className="promo-placeholder">
                  <div className="text-center">
                    ...
                    <h3 className="orbitron text-lg font-bold text-green-300">멤버십 트레이닝</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-green-900 text-green-300 rounded-full text-xs">팀빌딩</span>
                    <span className="px-3 py-1 bg-green-900 text-green-300 rounded-full text-xs">네트워킹</span>
                    <span className="px-3 py-1 bg-green-900 text-green-300 rounded-full text-xs">코딩캠프</span>
                  </div>
                </div>
              </div>
            </div>
